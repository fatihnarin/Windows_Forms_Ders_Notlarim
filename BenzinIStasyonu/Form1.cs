...
;        }
        ...
        {
            label2.Text = D_benzin95.ToString("N");
            label3.Text = D_benzin97.ToString("N");
            label5.Text = D_dizel.ToString("N");
            label7.Text = D_eurodizel.ToString("N");
            label9.Text = D_lpg.ToString("N");
        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            numericUpDown1.DecimalPlaces = 2;// virgülden sonra 2 basamak
            numericUpDown2.DecimalPlaces = 2;
            numericUpDown3.DecimalPlaces = 2;
            numericUpDown4.DecimalPlaces = 2;
            numericUpDown5.DecimalPlaces = 2;

            numericUpDown1.Increment = 0.1M;// kaçar kaçar artacak
            numericUpDown2.Increment = 0.1M;
            numericUpDown3.Increment = 0.1M;
            numericUpDown4.Increment = 0.1M;
            numericUpDown5.Increment = 0.1M;

            numericUpDown1.ReadOnly = true; // Dışarıdan veri girişi yapılamaz
